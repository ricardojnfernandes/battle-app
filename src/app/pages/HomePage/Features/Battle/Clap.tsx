...
// Inspired (aka copied from) https://www.freecodecamp.org/news/how-i-re-built-the-medium-clap-effect-and-what-i-got-out-of-the-experiment-991672995fdf/
...
export function Clap(props) {
    ...
    const animationTimeline = useRef(new mojs.Timeline());
    ...
    useEffect(() => {
        ...
        setCountTotal(generateRandomNumber(500, 10000));
    ...
    const handleClick = () => {
        animationTimeline.current.replay();
        setCount(Math.min(count + 1, 50));
        setCountTotal(countTotal + 1);
        setClicked(true);

        console.log('Punching!');
        dispatch(actions.punch(1));
    };
